...
import { BadgeDollarSign, CalendarDays, CircleMinus, NotebookText, Pencil, Plus, SearchIcon, Trash2 } from "lucide-react";
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-center gap-8">
              <h1 className="text-3xl text-zinc-700 font-bold">Despesas cadastradas</h1>
              ...
              <Modal open={open} >
                <h2 className="text-2xl text-zinc-700 font-bold">Cadastro de Despesas</h2>
            ...
            <CircleMinus className="w-8 h-8 text-zinc-700"/>           
          </div>
